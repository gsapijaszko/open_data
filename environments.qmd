...
To download CHELSA data in R you can use {ClimDatDownloadR} [@ClimDatDownloadR] package.
...
To download data in R you can use `WorldClim.xxx` set of functions in {ClimDatDownloadR} package or `worldclim_xxx` and `cmip6_xxx` sets of functions in {geodata} package [@geodata].
