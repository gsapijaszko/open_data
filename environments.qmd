...
It's worth to mention that {geodata} package have `landcover()` function, which can download downsampled to 30-seconds per pixel rasters for specific landcover class.
