...
Postal code boundaries are the third most common in OSM, however please be aware, that such information doesn't exist in each country. @fig-postal_code_distribution_map display the distribution this tag -- mostly used in Belgium, Germany, Vietnam and in few other spots across the globe.
...
```{=html}
<!--- 
https://giscienceblog.uni-heidelberg.de/2023/03/25/functionality-update-for-osm-landuse-landcover/
https://github.com/ailich/MultiscaleDTM/ - sprawdzić
-->
```
...
<!--
https://gis.stackexchange.com/questions/363315/can-i-extract-the-highway-layer-using-rs-sf-package
-->
