...
Separate ways for cycling usually are described as `highway = cycleway`, and in the field they are marked with white bicycle on blue background sign.[^osm-6]
...
They are tagged as a relations (several features grouped together with relation roles assigned)[^osm-9]; they can be of different network levels: `network = icn | ncn | rcn | lcn` which corresponds to international route, a national route, a regional route or a local route. Below an example of tagging of part of EuroVelo 9 route:
