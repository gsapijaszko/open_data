...
a <- sf::st_read("https://esa-worldcover.s3.eu-central-1.amazonaws.com/esa_worldcover_grid.fgb")
...
r <- terra::rast("s3://esa-worldcover/v200/2021/map/ESA_WorldCover_10m_2021_v200_N51E015_Map.tif")

r <- terra::rast("s3://esa-worldcover/v100/2020/map/ESA_WorldCover_10m_2020_v100_N00E009_Map.tif")
r
terra::plot(r)


aws.s3::bucket_exists(bucket = "s3://esa-worldcover/",
                      region = "eu-central-1")

wc_bucket <- aws.s3::get_bucket(bucket = "s3://esa-worldcover/",
                                region = "eu-central-1", 
                                max = 20000)
...
herbarium_files <- aws.s3::get_bucket_df(
